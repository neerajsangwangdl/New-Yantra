...
import { GlobalService } from 'src/app/services/shared/global-http.service';
import { GlobalHttpService } from 'src/app/services/shared/global-http.service.spec';
import { MasterService } from 'src/app/services/shared/master.service';
...
export class ProductListComponent implements OnInit {
  ...
  setFilters(isFilterChange = false) {
    ...
    this.productService.getProductList(this.filter).subscribe(res => {
      if (res.status == 200) {
        productPagingObj = res.data as ProductPaging;
